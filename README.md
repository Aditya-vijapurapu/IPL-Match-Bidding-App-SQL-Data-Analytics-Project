...
- Auction year and franchise
- Base price and final sold price
- Nationality and age
- Performance indicators (if included)
...
| Task | Tools |
|------|-------|
| Data Storage & Querying | MySQL / PostgreSQL / SQLite |
| SQL Analytics | Window functions, CTEs, Aggregations |
| Visualization | Tableau / Power BI / Python (optional) |
